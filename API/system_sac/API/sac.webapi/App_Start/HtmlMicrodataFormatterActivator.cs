...
[assembly: WebActivatorEx.PreApplicationStartMethod(typeof(sac.webapi.App_Start.HtmlMicrodataFormatterActivator), "ConfigureHtmlMicrodataFormatter")]

// This part configures routes that generate documentation, forms and links for your project at ~/api and ~/api/doc/{typeName}:
[assembly: WebActivatorEx.PreApplicationStartMethod(typeof(sac.webapi.App_Start.HtmlMicrodataFormatterActivator), "ConfigureDocumentationProvider")]
...
namespace sac.webapi.App_Start
{
    public static class HtmlMicrodataFormatterActivator
    {
        ...
        private static MediaTypeFormatter CreateHtmlMicrodataFormatter(HttpConfiguration config)
        {
            ...
            formatter.AddHeadContent(new XElement("title", "sac.webapi"));
